    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100 m-4">
                    <a href="{{route('users')}}" class="nav-item nav-link active"><i class="fa fa-user-alt me-2 "></i>users</a>
                </div>
                <div class="navbar-nav w-100 m-4">
                    
                    <a href="{{route('tasks')}}" class="nav-item nav-link active"><i class="fa fa-list-alt me-2 "></i>tasks</a>
                </div>
